...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3034u, /* Base address: 0x400F3000 Count: 52 */
			...
			0x400F4011u, /* Base address: 0x400F4000 Count: 17 */
		...
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x0000007Du);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_REG32((void *)(CYREG_UDB_INT_CFG), 0x0000007Eu);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00400182u);
	...
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x001B6D80u);
